...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 11 07:17:16 2023
...
def get_drift(id):# get drifter data from NOAA ERDDAP
    dfd=pd.read_csv('https://comet.nefsc.noaa.gov/erddap/tabledap/drifters.csvp?id%2Ctime%2Clatitude%2Clongitude%2Cdepth%2Csea_water_temperature&id=%22'+str(id)+'%22')
    return dfd
'''
