...
Apr 2021 - added 2021 option
May 2021 - pointed to /drifter after "sshfs jmanning@155.206.139.160:/drifter /drifter -o nonempty"
"""
...
for k in range(len(project)):
  if os.path.exists('/drifter/drift_'+project[k]+'_2016_'+consecutive_batch[k]+'_ap3.dat'): # for now, we are storing ALL ep AP3 data in this 2016 file
     os.remove('/drifter/drift_'+project[k]+'_2016_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2016_'+consecutive_batch[k]+'_ap3.csv') # uncommented dec 17, 2018 when Cassie noted problem missing Canaries
  elif os.path.exists('/drifter/drift_'+project[k]+'_2017_'+consecutive_batch[k]+'_ap3.dat'): # for now, we are storing ALL ep AP3 data in this 2017 file
     os.remove('/drifter/drift_'+project[k]+'_2017_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2017_'+consecutive_batch[k]+'_ap3.csv')
  elif os.path.exists('/drifter/drift_'+project[k]+'_2018_'+consecutive_batch[k]+'_ap3.dat'): # for now, we are storing ALL ep AP3 data in this 2018 file
     os.remove('/drifter/drift_'+project[k]+'_2018_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2018_'+consecutive_batch[k]+'_ap3.csv')# uncommented 5/1/2021
  elif os.path.exists('/drifter/drift_'+project[k]+'_2019_'+consecutive_batch[k]+'_ap3.dat'): # added these on Feb 1, 2019
     os.remove('/drifter/drift_'+project[k]+'_2019_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2019_'+consecutive_batch[k]+'_ap3.csv')
  elif os.path.exists('/drifter/drift_'+project[k]+'_2020_'+consecutive_batch[k]+'_ap3.dat'): # added these on Jan 14, 2020
     os.remove('/drifter/drift_'+project[k]+'_2020_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2020_'+consecutive_batch[k]+'_ap3.csv')
  elif os.path.exists('/drifter/drift_'+project[k]+'_2021_'+consecutive_batch[k]+'_ap3.dat'): # added these on Apr 7, 2021
     os.remove('/drifter/drift_'+project[k]+'_2021_'+consecutive_batch[k]+'_ap3.dat')
     os.remove('/drifter/drift_'+project[k]+'_2021_'+consecutive_batch[k]+'_ap3.csv')
    ...
    try:
      ...
      if data['momentForward'][0]['Device']['esn'][-6:] in esn2: #make sure that is drifter or miniboat data where "esn2" comes from codes_ap3
         if int(parser.parse(data['momentForward'][0]['Device']['moments'][0]['Moment']['date']).strftime('%s')) not in date_all: #make sure that this is not a repeat time
          ...
          # added the following line on 6/1/2020 to ignore sections of miniboat track
          #Bobcat
          if (str(esn[-6:])=='484660') and ((datet>datetime.datetime(2019,6,8,0,0,tzinfo=None)) and (datet<datetime.datetime(2020,2,21,0,0,tzinfo=None))):
                      continue
          #Norhthampton Soujourners Truth
          if (str(esn[-6:])=='111640') and ((datet>datetime.datetime(2018,6,6,15,0,tzinfo=None)) and (datet<datetime.datetime(2020,10,26,1,0,tzinfo=None))):
                      continue
          #Liberty		  
          ...
          if (str(esn[-6:])=='085940') and ((datet>datetime.datetime(2018,9,5,0,2,tzinfo=None)) and (datet<datetime.datetime(2020,3,6,13,0,tzinfo=None))):
                      continue
          # Great Northern
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,4,18,21,0,tzinfo=None)) and (datet<datetime.datetime(2021,4,19,1,0,tzinfo=None))):
                      continue 
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,4,30,23,30,tzinfo=None)) and (datet<datetime.datetime(2021,5,4,14,30,tzinfo=None))):
                      continue 
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,5,7,21,0,tzinfo=None)) and (datet<datetime.datetime(2021,7,9,5,30,tzinfo=None))):
                      continue 
          ...
          if (str(esn[-6:])=='484660') and (datet>datetime.datetime(2020,2,21,0,0,tzinfo=None)):
                     id_idn1=202471951
          #Soujourners Truth           
          if (str(esn[-6:])=='111640') and (datet>datetime.datetime(2020,10,26,1,0,tzinfo=None)):
                     id_idn1=200410713
          #Boat a Lahti
          ...
          if (str(esn[-6:])=='484980') and (datet>=datetime.datetime(2020,7,22,12,0,tzinfo=None)):
                     id_idn1=207461251                       
          #Great Northern           
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,4,16,2,0,tzinfo=None)) and (datet<datetime.datetime(2021,4,18,21,0,tzinfo=None))):
                     id_idn1=214461251
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,4,19,1,0,tzinfo=None)) and (datet<datetime.datetime(2021,4,30,23,30,tzinfo=None))):
                     id_idn1=214461252
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,5,4,14,30,tzinfo=None)) and (datet<datetime.datetime(2021,5,7,21,0,tzinfo=None))):
                     id_idn1=215461251
          if (str(esn[-6:])=='006590') and ((datet>datetime.datetime(2021,7,9,5,30,tzinfo=None)) and (datet<datetime.datetime(2030,5,7,21,0,tzinfo=None))):
                     id_idn1=217461251
          ...
          if (lat<>0.00000) and (lon<>0.00000): # added "lon" to this on 28 Mar 2019
                 ...
                 if endtime[idx]>date>starttime[idx]: #
                     if not os.path.exists('/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.dat'):
                          print '/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.dat'
                          f_output=open('/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.dat','w').close()
                          f_outcsv=open('/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.csv','w')
                          f_outcsv.write("ID,ESN,MTH,DAY,HR_GMT,MIN,YEARDAY,LON,LAT,DEPTH\n")
                          f_outcsv.close()
                     f_output=open('/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.dat','a')
                     ...
                     f_outcsv=open('/drifter/drift_'+project_name+'_'+yr+'_'+consecutive_batch_name+'_ap3.csv','a')
...
for k in range(len(unique_projects)):
  ...
  if unique_projects[k]=='ep':
      #os.system('cat /drifter/drift_'+unique_projects[k]+'_2016_1_ap3.dat >> /drifter/drift_'+unique_projects[k]+'_2016_1.dat')# added this 12/15/2018
      os.system('cat /drifter/drift_'+unique_projects[k]+'_2016_2_ap3.dat >> /drifter/drift_'+unique_projects[k]+'_2016_2.dat')
      for kk in list(range(2016,2022)):# added "list" to this on 8 Apr 2021 
        os.system('cat /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1_ap3.dat >> /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1.dat')
        os.system('cat /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1_ap3.csv >> /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1.csv')# added 4/9/2018
        #sort_track_by_time('/drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1.csv')# added Dec 2019 to fix issues with time being out of order for a few days
      for kk in list(range(2018,2022)):# added "list" and "2022" on 8 Apr 2021
        #os.system('cat /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1.dat >> /drifter/drift_X.dat')# added 9/18/2019 when not all miniboats showed up in stats
        os.system('cat /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1_ap3.dat >> /drifter/drift_X.dat')
        try:
          dd=pd.read_csv('/drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1_ap3.csv') #uncommented 6/4/18
          dd.to_csv('new.csv',header=False,index=False)#uncommented 6/4/18
          os.system('cat new.csv >> /drifter/drift_X.csv')#uncommented 6/4/18
        except:
          print 'WARNING:  /drifter/drift_'+unique_projects[k]+'_'+str(kk)+'_1_ap3.csv'+' does not exist'  
  elif unique_projects[k]=='madeira':
      os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat >> /drifter/drift_'+unique_projects[k]+'_2017_1.dat')
      os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.csv >> /drifter/drift_'+unique_projects[k]+'_2017_1.csv')
      os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat >> /drifter/drift_ep_2017_1.dat')
      #os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat >> /drifter/drift_X.dat')
  elif unique_projects[k]=='crmm':
      os.system('cp /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat  /drifter/drift_'+unique_projects[k]+'_2017_1.dat')
      os.system('cp /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.csv  /drifter/drift_'+unique_projects[k]+'_2017_1.csv')
      os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat >> /drifter/drift_ep_2017_1.dat')
      #os.system('cat /drifter/drift_'+unique_projects[k]+'_2017_1_ap3.dat >> /drifter/drift_X.dat')
      #os.system('cp /drifter/drift_'+unique_projects[k]+'_2018_1_ap3.dat  /drifter/drift_'+unique_projects[k]+'_2018_1.dat')
      #os.system('cp /drifter/drift_'+unique_projects[k]+'_2018_1_ap3.csv  /drifter/drift_'+unique_projects[k]+'_2018_1.csv')
      #os.system('cat /drifter/drift_'+unique_projects[k]+'_2018_1_ap3.dat >> /drifter/drift_ep_2018_1.dat')# commented 4/30/2021 after problem noticed
...
pipe31 = subprocess.Popen(['/home/jmanning/anaconda2/bin/python','/net/home3/ocn/jmanning/py/drift2xml.py','drift_ep_2018_1'])
...
pipe44 = subprocess.Popen(['/home/jmanning/anaconda2/bin/python','/net/home3/ocn/jmanning/py/drift2xml.py','drift_ep_2021_1'])# added this Feb 15, 2021
...
#os.system('cat /drifter/drift_smcc_2018_1.dat >> /drifter/drift_X.dat') 
os.system('cat /drifter/drift_dick_2020_2.dat >> /drifter/drift_X.dat') 
#os.system('cat /drifter/drift_whs_2019_1_ap3.dat >> /drifter/drift_X.dat')
#dd=pd.read_csv('/drifter/drift_whs_2019_1_ap3.csv')
#dd.to_csv('new.csv',header=False,index=False)
#os.system('cat new.csv >> /drifter/drift_X.csv')
...
#pipe8 = subprocess.Popen(['/home/jmanning/anaconda2/bin/python','/home/jmanning/py/drift2xml.py','drift_X'])
